...
use crate::app::delay;
use crate::app::{
    fake_duration, fake_media_file, CardsLoading, DurationSeconds, Media, MediaCard, MediaFile,
    MediaId, MediaPageHeader, SeriesIcon,
};
use leptos::prelude::*;
...
pub struct SeriesPage {
    data: Resource<Result<Vec<Media>, ServerFnError>>,
}
